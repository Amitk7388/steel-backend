...
class CustomOrder extends Component {
    constructor(props) {
        ...
        this.state={
            ...
            rightUploadedText:"",
            leftUploadedText:"",
            defaultLeftLogo : "translate(-195px,40px)",
            defaultRightLogo : "translate(-195px,40px)",
        }
      ...
      selectedRightButton(){
        ...
        uploaderLeftImage(event){
            ...
            if (event.target.files && event.target.files[0]) {
                ...
                reader.onload = (e) => {
                   console.log(e)
                    this.setState({leftUploadedImage: e.target.result});
                };
        ...
        uploaderRightImage(event){
            ...
            if (event.target.files && event.target.files[0]) {
                ...
                reader.onload = (e) => {
                    ...
                    this.setState({rightUploadedImage: e.target.result});
                };
                reader.readAsDataURL(event.target.files[0]);
            }              
        }
        ...
        uploadRightLogo2() {
            // alert(Logo)
            this.setState({uploadrightLogo2: Logo2})
        }
        ...
        RedColorTxt() {    
            this.setState({CaseColor: "#ca3432"})   
        }
        BlackColorTxt() {    
        this.setState({CaseColor: "#000000"})   
        }
        LightYellowColorTxt() {    
        this.setState({CaseColor: "#f2e9a4"})   
        }
        BlueColorTxt() {    
        this.setState({CaseColor: "#2269d6"})   
        }
        SkyBlueColorTxt() {    
        this.setState({CaseColor: "#01bbec"})   
        }
        VioletColorTxt() {    
        this.setState({CaseColor: "#9b508b"})   
        }
        whiteColorTxt() {    
        this.setState({CaseColor: "#ebedea"})   
        }
        YellowColor() {    
        this.setState({CaseColor: "#e3e64d"})   
        }
        c2Click() {    
                ...
                <div className="row">
                    ...
                    <section>
                        <div className="col-md-6">
                            <div className="row">            
                                <div className="product-preview" style={{display:this.state.actionChecker}}>
                                <img style={{display:"", width:"auto", height:"360px", marginLeft: '-200px', position: 'inherit'}}  src={require('../../assets/image/SS_U9_side.png')}/>

                                <img className="responsive" style={{display:"", width:"249px", height:"326px", marginLeft:"-450px", marginTop:"0px", paddingLeft:"-60px", position: 'absolute'}} id="adel-mask-preload-left"  src={this.state.leftShell} />

                                    <span style={{fontSize: "20px", marginTop:"-160px", marginLeft: "175px", zIndex: 1, color: this.state.CaseColor}}>{this.state.leftUploadedText}</span>

                                {this.state.leftUploadedImage ==="" ? <img className="responsive logoooo" style={{width:"86px", paddingRight:"-62px", marginLeft:"-191px", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'relative', transform:this.state.defaultLeftLogo}} id="adel-mask-preload-left"  src={this.state.defaultLogoLeft}/>
                                :
                                <img className="responsive" style={{width:"86px", height:"86px", paddingRight:"-62px", marginLeft:"-191px", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'relative', transform: this.state.defaultRightLogo}} id="adel-mask-preload-left"  src={this.state.leftUploadedImage}/>
                                
                                 }
                                <img className="responsive mainImg" style={{width:"202px", height:"329px", marginTop:"0px", zIndex:"-1px", marginLeft:"-325px", position: 'absolute'}} id="adel-mask-preload-left"  src={this.state.left} />

                                <img className="responsive" style={{ width:"211px", height:"341px", marginLeft:"-150px", marginTop:"0px", position: 'absolute'}} id="adel-mask-preload-left"  src={this.state.rightShell}/>
                                       
                                    <span style={{fontSize: "20px", marginTop:"-160px", marginLeft: "411px", zIndex: 1, color: this.state.CaseColor}}>{this.state.rightUploadedText}</span>

                                <img className="responsive" style={{width:"202px", height:"327px", marginLeft:"-127px", position: 'absolute', marginTop:"10px"}} id="adel-mask-preload-left"  src={this.state.right}/>
                                {this.state.rightUploadedImage ==="" ?

                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'relative',transform: 'translate(80px, 50px)'}}  src={this.state.defaultLogoRight}/>
                                :
                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'relative',transform: 'translate(80px, 50px)'}}  src={this.state.rightUploadedImage}/>
                                }
                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"-356px", zIndex: "1", borderRadius:"30%", position: 'initial'}}  src={this.state.uploadrightLogo}/>

                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"-356px", zIndex: "1", borderRadius:"30%", position: 'initial'}}  src={this.state.uploadrightLogo2}/>
                                </div>
