...
export default class FacePlate extends Component {
        constructor(props){
            super(props);
            this.state= {
                name: 'https://api.punkapi.com/v2/beers',
                users:[],
    ...
    onClickDemo(type) {
       // for(let i=1;i<10; i++){
            //this.setState({name:this.state.users[i].image_url})
            this.setState({name:"http://stealthsonics.com/1101/fpp/lf15.png"})
           //alert(this.state.users[i].image_url)
       // }
    }   
            ...
            <div> 
                ...
                <div>              
                    <ul className="nav nav-pills tab-category" style={{fontSize:"15px" }}>
                        <li className="active"><a data-toggle="pill" href="#premium">FacePlate</a></li>
