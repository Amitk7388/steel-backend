...
import rf34 from '../../assets/image/faceplates/custom/rf34.png'
...
class CustomOrder extends Component {
    ...
    // onClickDemo() {       
    //     this.setState({name:"http://stealthsonics.com/1101/fpp/lf15.png"})
    // }

    // handleColorName = (name) => {
    ...
    render() {
        ...
        console.log('parent ' + this.state.initialText);
                    ...
                    <div className="col-md-3">
                        <div className="item-customize"> 
                            <div>
                                ...
                                {/* <img onClick={this.onClickDemo} className="btn" style={{borderRadius:"50px", cursor:"pointer", marginLeft:""}} src="http://stealthsonics.com/1101/fpp/15.png"/> */}
                                ...
                                <FacePlate 
                                    ...
                                    handleCustomShell1 = {this.handleCustomShell1}
                                    handleCustomShell2 = {this.handleCustomShell2}
                                    handleCustomShell3 = {this.handleCustomShell3}
                                    handleCustomShell4 = {this.handleCustomShell4}
                                    handleCustomShell5 = {this.handleCustomShell5}
                                    handleCustomShell6 = {this.handleCustomShell6}
                                    handleCustomShell7 = {this.handleCustomShell7}
                                    handleCustomShell8 = {this.handleCustomShell8}
                                    handleCustomShell9 = {this.handleCustomShell9}
                                    handleCustomShell10 = {this.handleCustomShell10}
                                    handleCustomShell11 = {this.handleCustomShell11}
                                    handleCustomShell12 = {this.handleCustomShell12}
                                    handleCustomShell13 = {this.handleCustomShell13}
                                    handleCustomShell14 = {this.handleCustomShell14}
                                    handleCustomShell15 = {this.handleCustomShell15}
                                    handleCustomShell16 = {this.handleCustomShell16}
                                    handleCustomShell17 = {this.handleCustomShell17}
                                    handleCustomShell18 = {this.handleCustomShell18}
                                    handleCustomShell19 = {this.handleCustomShell19}
                                    handleCustomShell20 = {this.handleCustomShell20}
                                    handleCustomShell21 = {this.handleCustomShell21}
                                    handleCustomShell22 = {this.handleCustomShell22}
                                    handleCustomShell23 = {this.handleCustomShell23}
                                    handleCustomShell24 = {this.handleCustomShell24}
                                    handleCustomShell25 = {this.handleCustomShell25}
                                    handleCustomShell26 = {this.handleCustomShell26}
                                    handleCustomShell27 = {this.handleCustomShell27}
                                    handleCustomShell28 = {this.handleCustomShell28}
                                    handleCustomShell29 = {this.handleCustomShell29}
                                    handleCustomShell30 = {this.handleCustomShell30}
                    ...
                    <section>
                        <div className="col-md-6">
                            <div className="row">            
                                ...
                                <img className="responsive" style={{display:"", width:"250px", height:"250px", paddingRight:"-60px", marginLeft:"40px", marginTop:"89px"}} id="adel-mask-preload-left"  src={this.state.leftShell}/>

                                {/* <span style={{paddingRight:"-60px", marginRight:"35px", marginTop:"-145px", marginLeft: "85px", zIndex: 1,}}>{this.state.initialText}</span> */}

                                <img className="responsive mainImg" style={{display:"",
                                 width:"250px", height:"250px", marginTop:"83px", zIndex:"-1px", marginLeft:"-252px"}} id="adel-mask-preload-left"  src={this.state.left}/>

                                <img className="responsive" style={{display:"", width:"250px", height:"250px", paddingRight:"-60px", marginRight:"39px", marginTop:"89px"}} id="adel-mask-preload-left"  src={this.state.rightShell}/>
                                       
                                {/* <span style={{paddingRight:"-60px", marginRight:"35px", marginTop:"-145px", marginLeft: "425px", zIndex: 1,}}>{this.state.initialText}</span> */}

                                <img className="responsive" style={{display:"", width:"250px", height:"250px", marginLeft:"-285px", marginTop:"84px"}} id="adel-mask-preload-left"  src={this.state.right}/>
                                </div>
                           </div>                                    
                        ...
                        <div className="">
                            ...
                            {/* <span style={{marginLeft:"36px", marginTop:"15px", width:"120px"}} className="btn btn-info" onClick>LEFT</span>

                            <span style={{marginLeft:"16px", marginTop:"15px", width:"247px"}} className="btn btn-info">BOTH</span>

                            <span style={{marginLeft:"16px", marginTop:"15px", width:"120px"}} className="btn btn-info">RIGHT</span> */}
